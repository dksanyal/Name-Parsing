...
import argparse
from char_seq2seq_utils import *
...
ap.add_argument('-layer_num', type=int, default=3) #no need in rnn 
ap.add_argument('-hidden_dim', type=int, default=500) 
ap.add_argument('-nb_epoch', type=int, default=3)  
...
if __name__ == '__main__':
    ...
    # Performing test if we chose test mode
        ...
        if len(saved_weights) == 0:
            ...
            X_test = load_test_data('test.names', X_word_to_ix, MAX_LEN)
            ...
            sequences=process_output(sequences,'test.names')
